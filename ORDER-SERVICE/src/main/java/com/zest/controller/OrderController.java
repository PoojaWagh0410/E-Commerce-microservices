...
//-------------------------------------------------------------------------------------------------------
      ...
      protected ResponseEntity<OrderedProductResponse> getProductById(@PathVariable String productId) {
            OrderedProductResponse product = orderService.getProductById(productId);
            if (product != null)
